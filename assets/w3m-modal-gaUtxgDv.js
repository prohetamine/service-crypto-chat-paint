import{M as x,a9 as te,R as c,C as ne,c as g,r as j,a as m,i as b,b as d,n as l,z as k,A as z,D as u,e as se,k as f,v as D,y as L,a4 as le,V,E as U,O as R,s as F,g as ce,S as A,K as T,a1 as q,T as de,U as ie,aa as ue,ab as he}from"./index-DAzg_guw.js";import{P as _}from"./index-CPNDn5Zh.js";import{S as pe}from"./SwapController-C0C4RRaB.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
